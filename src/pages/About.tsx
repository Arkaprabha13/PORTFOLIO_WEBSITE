...
import { 
  ...
  TrendingUp, Target, Users, Zap, BookOpen, Coffee, Gamepad2 , Building
} from 'lucide-react';
...
const About = () => {
  ...
  {
    year: '2025',
    title: 'Winner – Status Code 2 Hackathon',
    description: 'Led development of KRISHAK, India’s first SMS-based AI advisory for feature-phone farmers',
    icon: Award,
    color: 'from-amber-500 to-orange-600',
    duration: 'Aug 2025',
    achievements: [
      '1st Place among 100+ teams',
      'Solved real-world agri-advisory gap for non-smartphone users',
      'Validated impact with 1000+ farmer interactions'
    ],
    tags: ['Hackathon', 'AI for Social Good', 'Award', 'KRISHAK']
  },
  {
    year: '2025',
